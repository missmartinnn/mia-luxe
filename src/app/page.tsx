  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="w-full h-[50vh] bg-pink-50/60 flex flex-col justify-center items-center text-center p-6 mb-16 rounded-sm border border-pink-100/40">
        ...
        <h1 className="text-3xl md:text-5xl font-extralight tracking-widest mb-4 text-neutral-50 uppercase">
          Elegance Defined
        </h1>
      ...
      <div className="text-left mb-8">
        <h2 className="text-lg font-medium tracking-widest text-neutral-50 uppercase mb-2">Curated Arrivals</h2>
